...
public class View_AsignarCliente_Clientes extends AppCompatActivity {
            ...
            protected void onPostExecute(Connection conn) {
                ...
                if (connection != null) {
                    try {
                        ...
                        List<Ent_Trab> trabs = new DB_InfTrab(connection, View_AsignarCliente_Clientes.this).execute().get();// Agregar todos los ascensores a la lista
                        // Configurar el adaptador
                        Adapter_trab adapter = new Adapter_trab(View_AsignarCliente_Clientes.this, trabs);
