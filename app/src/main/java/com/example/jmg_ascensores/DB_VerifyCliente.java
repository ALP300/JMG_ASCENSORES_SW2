...
public class DB_VerifyCliente extends AsyncTask<String, Void, String> { // Cambiar tipo de retorno a String
    private Connection connection;
    private Context context;

    // Constructor que recibe la conexión y el contexto de MainActivity
    public DB_VerifyCliente(Connection connection, Context context) {
    ...
    protected void onPostExecute(String result) {
        if (result != null) {
            ...
            Intent intent = new Intent(context, Home_Cliente.class);
