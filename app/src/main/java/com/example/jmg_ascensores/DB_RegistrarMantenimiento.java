...
public class DB_RegistrarMantenimiento extends AsyncTask<String, Void, Integer> { // Cambiar el tipo de retorno a Integer
    private Connection connection;
    private Context context;

    public DB_RegistrarMantenimiento(Connection connection, Context context) {
