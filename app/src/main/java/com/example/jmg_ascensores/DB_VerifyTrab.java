...
public class DB_VerifyTrab extends AsyncTask<String, Void, Boolean> {
    private Connection connection;
    private AppCompatActivity activity; // Cambiado a AppCompatActivity

    public DB_VerifyTrab(Connection connection, AppCompatActivity activity) { // Cambiado a AppCompatActivity
    ...
    protected void onPostExecute(Boolean success) {
        if (success) {
            ...
            Intent intent = new Intent(activity, Home_Trab.class); // Asegúrate de que este nombre de actividad sea correcto
