    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ConnectToDatabaseTask() {
            ...
            protected void onPostExecute(Connection conn) {
                ...
                if (connection == null) {
                    Toast.makeText(TrabajadorNuevo.this, "Error al conectar con la base de datos.", Toast.LENGTH_LONG).show();
                }
            }
        }.execute();
        ...
        registrarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(TrabajadorNuevo.this, "La edad debe ser un número.", Toast.LENGTH_SHORT).show();
                    return;
                }

                // Llamamos a la tarea para registrar el trabajador
                if (connection != null) {
                    new VerifyTrabajadorRegistroTask(connection, TrabajadorNuevo.this)
                    ...
                    Toast.makeText(TrabajadorNuevo.this, "Conexión a la base de datos no disponible.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
